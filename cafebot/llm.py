...
class AzureLLMClient:
    ...
    def _system_prompt(self, user_name: str | None = None, lang_hint: str = "en", current_order: str | None = None) -> str:
        ...
        return (
            ...
            "- remove: user wants to remove or cancel a drink from their order (e.g., 'remove the Americano', 'I don't want the Cold Brew anymore', 'cancel the Matcha Latte', 'skip the Espresso'). "
            ...
            "- checkout: user wants to finish and pay (e.g., 'I'm done', 'checkout', 'let's pay', 'that's all'). "
