...
class AzureLLMClient:
    ...
    def _system_prompt(self, user_name: str | None = None, lang_hint: str = "en", current_order: str | None = None) -> str:
        ...
        return (
            ...
            "- order: user wants to add a drink to their order, whether explicitly or tentatively (e.g., 'I want a Matcha Latte', 'can I get an Americano', 'im thinking trying the Rose Latte', 'how about a Cold Brew', 'Rose Latte sounds good', 'Ill go with the Matcha', 'lets do the Chai Latte', 'add an Espresso', 'mau pesan Matcha Latte', 'boleh minta Cold Brew'). "
            ...
            "[LANG:en][INTENT:order|DRINK:Rose Latte] Lovely pick! Rose Latte added to your order. "
            "[LANG:en][INTENT:order|DRINK:Hot Chocolate] Great choice! One Hot Chocolate added to your order. "
            "[LANG:id][INTENT:order|DRINK:Matcha Latte] Pilihan bagus! Matcha Latte sudah aku tambahkan. "
